...
from oilify_studio_backend.services.oil_price import OilPricePoint


def _build_price_points() -> list[OilPricePoint]:
...
def test_seed_initial_tickers_seeds_tickers_and_historical_prices(db_session, monkeypatch) -> None:
    ...
    monkeypatch.setattr("oilify_studio_backend.db.seed.fetch_historical_oil_prices", lambda days=30: points)
